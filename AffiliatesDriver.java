...
// use InputMismatchException to handle user input
...
public class AffiliatesDriver {
  ...
  public static void main(String[] args){
    ...
    try{
      while(menuOption != 7){
        ...
        if(menuOption == 1){
          ...
          if(createOption == 1){
            ...
            System.out.println("Invalid Input: input did not match any integer 1 - 7.");
      ...
      System.out.println("Error: invalid input, please follow input instructions.");
      error.printStackTrace();
    }
  }
}
